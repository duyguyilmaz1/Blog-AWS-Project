...
DATABASES = {
    'default': {
        ...
        'HOST': 'awsproject-rds.cfcuoky0kj6k.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awsprojectduygublog' # please enter your s3 bucket name
